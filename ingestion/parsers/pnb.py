"""Punjab National Bank forex card rates PDF parser."""
...
class PNBParser(BankParser):
    ...
    SOURCE_URL = (
        "https://www.pnbindia.in/downloadprocess.aspx?fid=A+rrvZeJc+PIaxfEqVTIQQ%3D%3D"
    )
            ...
            for row in table:
                ...
                return [
                    ParsedRate(
                        ...
                        source_title="PNB Forex Card Rates",
