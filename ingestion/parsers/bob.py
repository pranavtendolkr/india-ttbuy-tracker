"""Bank of Baroda forex card rates HTML parser."""
...
class BankOfBarodaParser(BankParser):
    ...
    SOURCE_URL = (
        "https://www.bankofbaroda.in/business-banking/treasury/forex-card-rates"
    )
            ...
            for tr in table.find_all("tr"):
                ...
                return [
                    ParsedRate(
                        ...
                        source_title="Bank of Baroda Forex Card Rates",
